...
cd /usr/bin
wget -O add-ss "https://raw.githubusercontent.com/melody97rain/SyntaxError/main/add-user/add-ss.sh"
wget -O del-ss "https://raw.githubusercontent.com/melody97rain/SyntaxError/main/delete-user/del-ss.sh"
wget -O cek-ss "https://raw.githubusercontent.com/melody97rain/SyntaxError/main/cek-user/cek-ss.sh"
wget -O renew-ss "https://raw.githubusercontent.com/melody97rain/SyntaxError/main/renew-user/renew-ss.sh"
wget -O ssssr "https://raw.githubusercontent.com/melody97rain/SyntaxError/main/menu/ssssr.sh"
chmod +x add-ss
chmod +x del-ss
chmod +x cek-ss
chmod +x renew-ss
